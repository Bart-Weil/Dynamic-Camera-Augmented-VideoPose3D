...
def parse_args():
    ...
    # Model selection
    parser.add_argument('--use-model', dest='use_model', default='FCN', type=str, help='FCN, LSTM-Uncoupled, Transformer, LSTM-Coupled')
    ...
    parser.add_argument('--lstm-dropout', dest='lstm_dropout', default=0.5, type=float, metavar='P', help='LSTM dropout probability')
    ...
    parser.add_argument('--transformer-dropout', dest='transformer_dropout', default=0.5, type=float, metavar='P', help='transformer dropout probability')
